...
% Missed dose analysis population variability for different set of patients - driver
...
% Use case_no = 1, to have result for 5 subjects
% Use case_no = 2, to have result for 10 subjects
% Use case_no = 3, to have result for 50 subjects
% Use case_no = 4, to have result for 75 subjects
% Use case_no = 5, to have result for 100 subjects
...
switch case_no
    case 1
        ...
        save change_means5.mat change_mean
        save AUc_values_pop5.mat AUC_c AUC_c1 AUC_c2 AUC_c3 AUC_c4 AUC_cm
        save c_p_values_delayed_pop5.mat Ct_c1 Ct_c2 Ct_c3 Ct_c4 Pk_c1 Pk_c2 Pk_c3 Pk_c4 ct_times p_times
        save c_p_values_missed_pop5.mat Ct_c5 Pk_c5 missed_DoseT timesm
        save conc_normal_pop5.mat Tc Y_c 
        save conc_delayed_pop5.mat Tc1 Tc2 Tc3 Tc4 Y_c1 Y_c2 Y_c3 Y_c4  
        save c_p_normal_pop5.mat Ct_c Pk_c DoseTimes times
        save conc_missed_pop5.mat Tcm Y_cm
    case 2
        ...
        save change_means10.mat change_mean
        save AUc_values_pop10.mat auc
        save c_p_values_delayed_pop10.mat Ct_c1 Ct_c2 Ct_c3 Ct_c4 Pk_c1 Pk_c2 Pk_c3 Pk_c4 ct_times p_times
        save c_p_values_missed_pop10.mat Ct_c5 Pk_c5 missed_DoseT timesm
        save conc_normal_pop10.mat Tc Y_c 
        save conc_delayed_pop10.mat Tc1 Tc2 Tc3 Tc4 Y_c1 Y_c2 Y_c3 Y_c4  
        save c_p_normal_pop10.mat Ct_c Pk_c DoseTimes times
        save conc_missed_pop10.mat Tcm Y_cm 
    case 3
        ...
        change = change(:,2:end)*100;
        change_mean = mean(change);
        save change_means50.mat change_mean
        save AUc_values_pop50.mat auc
        save c_p_values_delayed_pop50.mat Ct_c1 Ct_c2 Ct_c3 Ct_c4 Pk_c1 Pk_c2 Pk_c3 Pk_c4 ct_times p_times
        save c_p_values_missed_pop50.mat Ct_c5 Pk_c5 missed_DoseT timesm
        save conc_normal_pop50.mat Tc Y_c 
        save conc_delayed_pop50.mat Tc1 Tc2 Tc3 Tc4 Y_c1 Y_c2 Y_c3 Y_c4  
        save c_p_normal_pop50.mat Ct_c Pk_c DoseTimes times
        save conc_missed_pop50.mat Tcm Y_cm
    case 4
        ...
        change = change(:,2:end)*100;
        change_mean = mean(change);
        save change_means75.mat change_mean
        save AUc_values_pop75.mat auc        
        save c_p_values_delayed_pop75.mat Ct_c1 Ct_c2 Ct_c3 Ct_c4 Pk_c1 Pk_c2 Pk_c3 Pk_c4 ct_times p_times
        save c_p_values_missed_pop75.mat Ct_c5 Pk_c5 missed_DoseT timesm
        save conc_normal_pop75.mat Tc Y_c 
        save conc_delayed_pop75.mat Tc1 Tc2 Tc3 Tc4 Y_c1 Y_c2 Y_c3 Y_c4  
        save c_p_normal_pop75.mat Ct_c Pk_c DoseTimes times
        save conc_missed_pop75.mat Tcm Y_cm
    case 5
        ...
        change = change(:,2:end)*100;
        change_mean = mean(change);
        save change_means100.mat change_mean
        save AUc_values_pop100.mat auc
        save c_p_values_delayed_pop100.mat Ct_c1 Ct_c2 Ct_c3 Ct_c4 Pk_c1 Pk_c2 Pk_c3 Pk_c4 ct_times p_times
        save c_p_values_missed_pop100.mat Ct_c5 Pk_c5 missed_DoseT timesm
        save conc_normal_pop100.mat Tc Y_c 
        save conc_delayed_pop100.mat Tc1 Tc2 Tc3 Tc4 Y_c1 Y_c2 Y_c3 Y_c4  
        save c_p_normal_pop100.mat Ct_c Pk_c DoseTimes times
        save conc_missed_pop100.mat Tcm Y_cm
end